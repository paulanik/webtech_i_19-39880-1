...
<div class="dash">
  ...
  <button type="button" class="block"><a href="store_hospital.php">Add New Hospital</a></button>
  <button type="button" class="block"><a href="store_user.php">Add New User</a><br></button>
